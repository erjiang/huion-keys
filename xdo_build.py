 ...
 */
// hard-coded shifts
#define SIZE_USEHINTS 1 // (1L << 0)
#define SIZE_USEHINTS_X 2 // (1L << 1)
#define SIZE_USEHINTS_Y 4 // (1L << 2)
 ...
 */
#define SEARCH_TITLE 1 // (1UL << 0)

/**
 * Search only window class.
 * @see xdo_search_windows
 */
#define SEARCH_CLASS 2 // (1UL << 1)

/**
 * Search only window name.
 * @see xdo_search_windows
 */
#define SEARCH_NAME 4 // (1UL << 2)

/**
 * Search only window pid.
 * @see xdo_search_windows
 */
#define SEARCH_PID 8 // (1UL << 3)

/**
 * Search only visible windows.
 * @see xdo_search_windows
 */
#define SEARCH_ONLYVISIBLE 16 // (1UL << 4)
 ...
 * @see xdo_search_windows
 */
#define SEARCH_SCREEN 32 // (1UL << 5)

/**
 * Search only window class name.
 * @see xdo_search
 */
#define SEARCH_CLASSNAME 64 // (1UL << 6)
 ...
 * @see xdo_search_windows
 */
#define SEARCH_DESKTOP 128 // (1UL << 7)
...
//                            int *x_ret, int *y_ret, Screen **screen_ret);
                            int *x_ret, int *y_ret, int **screen_ret);
...
ffibuilder.set_source("_xdo_cffi",
"""
     #include "xdo.h"   // the C header of the library
""",
     libraries=['xdo'])   # library name, for the linker
